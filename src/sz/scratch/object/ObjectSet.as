package sz.scratch.object {
	...
	public final class ObjectSet {
		...
		{
			trace(this + 'put ');
//			return putAt(obj, _length);
			var node : ObjectNode = new ObjectNode(obj);

			if(_table[obj] == null) {

				_table[obj] = node;
				trace('   ' + this + '_table[obj] = ' + _table[obj]);
		...
		public function putAt(obj : Object, $index : int) : Boolean
		{
			trace(this + 'putAt ');
		 ...
		 */
		public function cull(obj : Object) : Boolean
		{
		...
		private function _removeNode(node : ObjectNode) : void
		{
			_table[node.obj] = null;
			delete _table[node.obj];
			node.next = null;
			node.prev = null;
			node.obj = null;
			--_length;
		...
		{
			var node : ObjectNode = _table[$object] as ObjectNode;
			if(node && node.next)return node.next.obj;
			return null;
		}
		...
		{
			if(_head && _head.obj)return _head.obj;
			return null;
		}

		public function get tail() : Object
		{
			if(_tail && _tail.obj)return _tail.obj;
			return null;
		}
